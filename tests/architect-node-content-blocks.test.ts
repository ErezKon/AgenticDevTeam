...
function makeState(): ProjectStateType {
    return {
        ...
        devopsPlan: null, runningContainers: [], pullRequests: [], branchAssignments: [],
        ...
        configBaseline: null, acceptance: null, latestGateReport: null,
        unrecoverable: null, verificationErrors: [], dispatchRounds: [],
        attemptedBugIds: [], bugAttempts: {}, outputIntegrity: [], planViolations: [],
